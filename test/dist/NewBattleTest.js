...
var _a = contract_1.getProvider().getWallets(),
  alice = _a[0],
  bob = _a[1];
...
describe('::Battle', function () {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  ethereum_waffle_1.deployMockContract(alice, PepemonCardDeck_json_1['default'].abi),
                ];
              case 1:
              ...
              case 2:
                ...
                return [
                  4 /*yield*/,
                  ethereum_waffle_1.deployMockContract(alice, RandomNumberGenerator_json_1['default'].abi),
                ];
              case 3:
                randNrGen = _a.sent();
                return [
                  4 /*yield*/,
                  ethereum_waffle_1.deployContract(alice, PepemonBattle_json_1['default'], [
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  pepemonCardOracle.mock.getBattleCardById.withArgs(1).returns({
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  pepemonCardOracle.mock.getBattleCardById.withArgs(2).returns({
              ...
              case 2:
                ...
                return [
                  4 /*yield*/,
                  pepemonCardOracle.mock.getSupportCardById.withArgs(1).returns({
              ...
              case 3:
                ...
                return [
                  4 /*yield*/,
                  pepemonCardOracle.mock.getSupportCardById.withArgs(2).returns({
              ...
              case 4:
                ...
                return [
                  4 /*yield*/,
                  pepemonCardOracle.mock.getSupportCardById.withArgs(3).returns({
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  pepemonDeckOracle.mock.shuffleDeck
                    .withArgs(1)
                    .returns([
                      1,
                      3,
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  pepemonDeckOracle.mock.decks
                    .withArgs(1)
                    .returns(ethers_1.BigNumber.from(1), ethers_1.BigNumber.from(50)),
                ];
              case 2:
                _a.sent();
              ...
              case 4:
                ...
                return [
                  ...
                  pepemonDeckOracle.mock.decks
                    .withArgs(2)
                    .returns(ethers_1.BigNumber.from(2), ethers_1.BigNumber.from(45)),
                ];
              case 5:
                _a.sent();
      ...
      setupRandOracle = function () {
        return __awaiter(void 0, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, randNrGen.mock.getRandomNumber.returns(10)];
              case 1:
                _a.sent();
                return [2 /*return*/];
            }
      ...
      describe('#Battling', function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            beforeEach(function () {
              return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [4 /*yield*/, battleContract.createBattle(alice.address, 1, bob.address, 2)];
                    case 1:
                      _a.sent();
            ...
            it('should go for battle', function () {
              return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
