...
describe('::Battle', function () { return __awaiter(void 0, void 0, void 0, function () {
    var battleContract, pepemonDeckOracle, pepemonCardOracle, rng, setupCardOracle, setupDeckOracle, setupRNGOracle, logBattle, logPlayer, logHand, logTempSupportInfo, logTurn, logTurnHalves;
    return __generator(this, function (_a) {
        ...
        setupRNGOracle = function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rng.mock.getRandomNumber.returns(10)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        describe('#Battling', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                it('asdf', function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        logBattle(battle);
                        return [2 /*return*/];
                    });
